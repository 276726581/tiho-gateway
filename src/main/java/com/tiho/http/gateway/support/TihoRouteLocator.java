package com.tiho.http.gateway.support;
...
import com.tiho.http.gateway.util.LockCallback;
import com.tiho.http.gateway.util.MatcherUtil;
...
public class TihoRouteLocator extends SimpleRouteLocator implements InitializingBean, RefreshableRouteLocator {

    public TihoRouteLocator(String servletPath, ZuulProperties properties) {
